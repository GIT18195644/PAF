...
<body>
	...
	<table>
		<tr>
			<td>GET</td>
			<td>Get all the details of Hospitals</td>
		...
		<tr>
			<td>POST</td>
			<td>Create new Hospital record</td>
		...
		<tr>
			<td>PUT</td>
			<td>Update the Hospital details</td>
		...
		<tr>
			<td>GET</td>
			<td>Search Hospital details using Hospital ID: 1</td>
		...
		<tr>
			<td>DELETE</td>
			<td>Delete Hospital record using Hospital ID: 1</td>
